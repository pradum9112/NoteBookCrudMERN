...
const Notes = () => {
  ...
  return (
    <>
      <AddNote />
      <h2 className="text-2xl mt-8 font-bold bg-clip-text text-transparent bg-gradient-to-r from-yellow-400 via-blue-500 to-yellow-500">
        Your Notes
      </h2>
            ...
            <div className="bg-[#28231D] px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
              <div className="container">
                <div className="mb-3">
                  <label
                    htmlFor="etitle"
                    className="block text-lg font-medium text-[#ECEE81]"
                  >
                    Title
                  </label>
                  <input
                ...
                <div className="mb-3">
                  <label
                    ...
                    className="block text-lg font-medium text-[#82A0D8]"
                  >
                    Description
                  </label>
                  <textarea
                ...
                <div className="mb-3">
                  <label
                    htmlFor="edueDate"
                    className="block text-lg font-medium text-[#EDB7ED]"
                  >
                    Due Date
                  </label>
                  <textarea
